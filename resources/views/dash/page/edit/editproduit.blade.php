      ...
      <div class="row">
        <div class="col mt-1 order-xl-2">
          <div class="card ">
            ...
            <h2 class="text-muted mb-4 text-center"><img src="{{asset("img/produitlogo/logo1.png")}}" width="30px"> Moonair </h2>
            <hr>
            <div class="card-body">
            <form class="needs-validation" novalidate method="POST" action=" {{route("produit.update",12)}} ">
              @csrf
              @method("PUT")
